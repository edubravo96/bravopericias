...
<body>
  <header>
    ...
    <h2>Eduardo Bravo</h2>
    <p class="subtitle">Atuação técnica precisa e imparcial em processos judiciais. Especialista em perícias financeiras.</p>
  ...
  <section id="sobre">
    ...
    <ul>
      <li><strong>Formação Acadêmica:</strong> Bacharel em Administração</li>
      <li><strong>Registro Profissional:</strong> CRA-SP nº 093563</li>
  ...
  <section id="contato">
    ...
    <p><strong>Telefone / WhatsApp:</strong> <a href="tel:+5518991298238">(18) 99129-8238</a></p>
    ...
    <p><strong>Atendimento:</strong> Todo o Brasil (atuação online e presencial sob agendamento)</p>
  </section>

  <footer>
    <p>&copy; 2025 Eduardo Bravo - Bravo Perícias</p>
  </footer>
</body>
</html>
